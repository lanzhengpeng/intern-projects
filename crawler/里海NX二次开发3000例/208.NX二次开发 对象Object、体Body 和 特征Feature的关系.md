### NX二次开发 对象Object、体Body 和 特征Feature的关系
...
charD, douDir, &tagCylinderFeat);
	...
	tag_t  tagCylinderBody = NULL_TAG;
	UF_MODL_ask_feat_body(tagCylinderFeat, &tagCylinderBody); //获取特征的体（重要！）
	UF_OBJ_set_color(tagCylinderBody, 6); //涂色 黄色
