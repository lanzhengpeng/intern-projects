### UGNX二次开发 获取曲线上某个位置的点坐标、切线矢量、主法线矢量、副法线矢量 UF_MODL_ask_curve_props
...
tag_t tagCurve = vecObj[0]->Tag();
    ...
    for (int i = 0; i < (numpts - 1); i++)
    {
        ...
        double torsion;
        double rad_of_cur;
        UF_MODL_ask_curve_props(tagCurve, parm1, adTempPoint, tangent,
　　　　 p_norm, b_norm, &torsion, &rad_of_cur);
