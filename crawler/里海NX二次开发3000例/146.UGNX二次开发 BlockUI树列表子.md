...
void TreeListDemo::dialogShown_cb()
{
    try
    {
        ...
        //插入列        
        tree_control0->InsertColumn(ColumnFirst, "第1列", 120);
        tree_control0->InsertColumn(ColumnSecond, "第2列", 60);
        tree_control0->InsertColumn(ColumnThird, "第3列", 80);
